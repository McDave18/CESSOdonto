...
export class Placadbt6Service{
    ...
    { 
        ...
        return this._http.post('https://api.odontocess.org/api/placaact6',params,{headers:headers}); 
    ...
    { 
        ...
        let headers = new HttpHeaders().set('Content-Type','application/x-www-form-urlencoded');
        return this._http.get('https://api.odontocess.org/api/placaact6/'+id,{headers:headers}); 
